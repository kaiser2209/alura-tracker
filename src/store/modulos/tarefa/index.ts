...
import { OBTER_TAREFAS, CADASTRAR_TAREFA, ALTERAR_TAREFA } from "@/store/actions-type";
import { DEFINIR_TAREFAS, ADICIONA_TAREFA, ATUALIZA_TAREFA, REMOVE_TAREFA } from "@/store/mutations-type";
